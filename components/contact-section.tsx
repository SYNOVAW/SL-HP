    ...
    <section id="contact" className="relative z-10 py-20 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          >
            <span className="text-white/90 text-sm font-light">Get In Touch</span>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          {/* Contact Information */}
          <div>
            <h3 className="text-2xl font-medium text-white mb-8">Let's Start a Conversation</h3>
            ...
            <div className="mt-8 p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10" style={{ filter: "url(#glass-effect)" }}>
              ...
              <p className="text-white/70 text-sm">Monday - Friday: 9:00 AM - 6:00 PM JST</p>
              <p className="text-white/70 text-sm">Emergency Support: 24/7 for enterprise clients</p>
            </div>
          </div>
          ...
          >
            ...
            <form className="space-y-4">
              ...
              <div>
                <label className="block text-white/70 text-sm mb-2">Interest</label>
                <select className="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white focus:border-blue-400 focus:outline-none transition-colors">
                  ...
                  <option value="automation" className="bg-black">AI Financial Automation</option>
                  <option value="risk" className="bg-black">Risk Management</option>
                  <option value="trading" className="bg-black">Quantitative Trading</option>
